/*
 * Found in the libc source code
 *
 * http://www.opensource.apple.com/source/Libc/Libc-825.26/gen/assumes.h
 *
 * License can be found at 
 * http://www.opensource.apple.com/source/Libc/Libc-825.26/APPLE_LICENSE
 *
 */
